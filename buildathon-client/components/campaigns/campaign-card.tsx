...
export function CampaignCard({ campaign, viewType = 'brand', className }: CampaignCardProps) {
  const { id, name, description, budget, startDate, endDate, platforms, status } = campaign;
      ...
      <CardFooter className="pt-0 flex justify-between">
        {viewType === 'brand' ? (
          ...
          <div className="flex w-full gap-2">
            ...
            <Link href={`/discover/${id}/apply`} className="flex-1">
